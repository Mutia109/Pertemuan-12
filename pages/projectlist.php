        ...
        <?php
            ...
            if(count($arrayResult) == 0){
                ...
                foreach ($arrayResult as $dataProject) {
                    ...
                    echo '<td> <a class="btn btn-warning" href="index.php?p=project&pnumber='.$dataProject->pnumber.'"> Edit </a> 
                            | <a class="btn btn-danger" href="index.php?p=deleteproject&pnumber='.$dataProject->pnumber.'" 
